...
Left coverage for the equal case in tests/legacy/ so it doesn't regress. Those
aren't wired into evaluate.py yet, the legacy runner migration is still open.
